...
setwd("~/GitHub/Delay_Discounting/Boot_Data/FC/Nine_Under_Boot")
```
...
python_df = read.csv("C:/Users/jacob.derosa/Documents/Github/Delay_Discounting/Data/Nine_Under.csv", header = T, sep = ",") %>% rename(Key = X) #make sure subject Key is the first column of your dataframe
...
summary(aov(FA1 ~ Sex, data = Split_1))
