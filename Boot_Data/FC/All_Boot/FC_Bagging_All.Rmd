...
setwd("~/GitHub/Delay_Discounting/Boot_Data/FC/All_Boot")
```
...
python_df = read.csv("C:/Users/jacob.derosa/Documents/Github/Delay_Discounting/Data/Functional_Scaled.csv", header = T, sep = ",") %>% rename(Key = X) #make sure subject Key is the first column of your dataframe
