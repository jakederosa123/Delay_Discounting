...
vss(dom_polycor$correlations, n.obs = nrow(domain_data), rorate ="promax")
...
for (i in 1:nBoots){
  ...
  boot_corr <- hetcor(bootSamples)

  FABoot <- fa(r = boot_corr$correlations, n.obs = nrow(domain_matrix), nfactors = NumFactors, rotate = 'Promax', fm = "pa", scores = "Bartlett")
