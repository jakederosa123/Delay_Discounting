...
setwd("C:/Users/jacob.derosa/Desktop/Scripts/Temp_Disc_Splits/Boot_Data")
...
python_df = read.csv("C:/Users/jacob.derosa/Desktop/Scripts/Temp_Disc_Splits/CBCL_Split_1.csv", header = T, sep = ",") %>% rename(Key = X) #make sure subject Key is the first column of your dataframe
...
python_df2 = read.csv("C:/Users/jacob.derosa/Desktop/Scripts/Temp_Disc_Splits/CBCL_Split_2.csv", header = T, sep = ",") %>% rename(Key = X) 
